...
public abstract class AdvancedDirectional extends NetworkDirectional {
    ...
    protected abstract @NotNull int[] getBackgroundSlots();
    ...
    public  @NotNull int [] getItemSlots() {
        return new int[0];
    }
    ...
    public void updateShowIcon(@NotNull Location location) {
        ...
        itemMeta.setLore(lore);
        ItemStack stack = this.showIconClone.clone();
    ...
    public void updateTransportModeIcon(@NotNull Location location) {
        ...
        List<String> lore = new ArrayList<>();
        TransportMode mode=getCurrentTransportMode(location);
        lore.add( String.format(Lang.getString("messages.normal-operation.directional.transport_mode"), mode.getName()));
        lore.addAll(mode.getDescription());
        itemMeta.setLore(lore);
        ItemStack stack = this.transportModeIconClone.clone();
        stack.setItemMeta(itemMeta);
